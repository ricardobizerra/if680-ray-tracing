...
def main():
    ...
    esfera = Esfera(np.array([200, 0, 50]), 50, [255, 255, 0])  # Raio da esfera definido como 1
    plano = Plano(np.array([100,0,0]), np.array([0, 0, 1]), [255, 0, 0])  # Ponto e vetor normal ao plano definidos como 0
    p0 = np.array([100, 0, 0])
    p1 = np.array([0, 100, 0])
    p2 = np.array([-100, 0, 0])
    p3 = np.array([0, -100, 0])
